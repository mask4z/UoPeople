...
public class DrawTextPanel extends JPanel {
    ...
    private class Canvas extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (theStrings != null) for (DrawTextItem stringItem : theStrings) {
                stringItem.draw(g);
            }
        }
    }
...
//   SOME OTHER OPTIONS THAT CAN BE APPLIED TO TEXT ITEMS:
    ...
    public JMenuBar getMenuBar() {
        if (menuBar == null) {
            ...
            if (System.getProperty("mrj.version") == null) commandKey = "control ";  // command key for non-Mac OS
            else commandKey = "meta ";  // command key for Mac OS
