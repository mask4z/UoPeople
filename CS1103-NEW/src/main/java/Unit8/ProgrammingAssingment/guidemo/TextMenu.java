package Unit8.ProgrammingAssingment.guidemo;
...
public class TextMenu extends JMenu {
    ...
    public JMenu createJustifyMenu() {
        ...
        ActionListener justifyLeft = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        ActionListener justifyCenter = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        ActionListener justifyRight = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
