...
public class ProgrammingAssignment2 {
    ...
    private static String randomVerbPhrase() { //<intransitive_verb> | <transitive_verb> <noun_phrase> | is <adjective> | believes that <simple_sentence>
        return switch ((int) (Math.random() * 4) + 1) {
            ...
            case 2 ->
                randomItem(transitive_verb) + " " + randomNounPhrase();
            case 3 ->
                "is " + randomItem(adjective);
            case 4 ->
                "believes that " + randomSimpleSentence();
            default ->
                throw new IndexOutOfBoundsException("Random int in switch is either zero or 5!");
        };
    }
