...
public class GetTextDialog extends JDialog {
     ...
     * @param initialText the initial contents of the inputs box; if null, the
     * box is initially empty.
     * @return the text from the input box, or null if the user cancels the
     * dialog. Note that the return can be a blank string if the user clicks
     * "OK" without entering any text.
     */
