...
public class GuiDemo extends JFrame {
    ...
    public GuiDemo() {
        ...
        drawPanel.setBackgroundImage(Util.getImageResource("resources/images/bruce.jpg"));
    ...
    private JMenu makeBackgroundMenu() {
        ...
        gradientOverlayCheckbox.addActionListener((ActionEvent evt) -> {
    ...
    private class ChooseBackgroundAction extends AbstractAction {
        ...
        ChooseBackgroundAction(String text) {
            super(text);
            this.text = text;
            if (!text.equals("Custom...") && !text.equals("Color...") && !text.equals("Bruce")) {
            ...
            if (text.equals("Color...")) {
                ...
                g.fillRect(0, 0, (32 / 3), 32);
                g.setColor(Color.GREEN);
                g.fillRect((32 / 3), 0, (32 / 3), 32);
                g.setColor(Color.BLUE);
                g.fillRect((32 / 3) * 2, 0, (32 / 3), 32);
                g.dispose();
