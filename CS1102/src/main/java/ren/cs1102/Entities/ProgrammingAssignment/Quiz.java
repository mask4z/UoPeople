...
public class Quiz {
    ...
    public static void main(String[] args) {
        ...
        Question computerQ = new TrueFalseQuestion("Do all computers have a CPU?", "true");
        computerQ.check();

        Question waterQ = new TrueFalseQuestion("Does water contain three hydrogen elements?", "F");
        waterQ.check();

        Question foodQ = new TrueFalseQuestion("Is food something you can eat?", "T");
        foodQ.check();

        Question mouseQ = new TrueFalseQuestion("Can a mouse fly?", "False");
        mouseQ.check();
