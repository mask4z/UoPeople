package ren.cs1102.Entities.Inheritance_Polymorphism;

/**
 *  An object of type ren.cs1102.Entities.Inheritance_Polymorphism.Deck represents a deck of playing cards.  The deck
...
public class Deck {
     ...
     * randomize the order.  (Note that "new ren.cs1102.Entities.Inheritance_Polymorphism.Deck()" is equivalent
     * to "new ren.cs1102.Entities.Inheritance_Polymorphism.Deck(false)".)
     */
    public Deck() {
...
} // end class ren.cs1102.Entities.Inheritance_Polymorphism.Deck
